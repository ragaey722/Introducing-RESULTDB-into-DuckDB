...
static void BuildResultDBYannakakisOrder(const ResultDBYannakakisProgram &program,
	...
	order.clear();
	order.push_back(program.root_relation);
	visited[program.root_relation] = true;
