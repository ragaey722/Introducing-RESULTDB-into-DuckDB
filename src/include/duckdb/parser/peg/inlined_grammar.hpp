...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"Recursive <- 'RECURSIVE'\n"
	"SelectClause <- ResultDBSelectClause / RegularSelectClause\n"
	"ResultDBSelectClause <- 'SELECT' 'RESULTDB' TargetList\n"
	"RegularSelectClause <- 'SELECT' DistinctClause? TargetList?\n"
